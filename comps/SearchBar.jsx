...
const SearchBar = ({ children, setKeyBoardValue }) => {
  ...
  return (
    ...
    >
      ...
      <InputGroup>
        <Input
          onChange={(e) => (setKeyBoardValue(e.target.value),console.log(e.target.value))}
          color={"white"}
          as={motion.input}
          whileFocus={{ scale: 1.2, y: 10, backgroundColor: "rgb(65,76,80)" }}
        />
        {showIcon && (
          <InputRightElement
            as={motion.div}
